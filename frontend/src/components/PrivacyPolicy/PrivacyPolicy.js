...
const PrivacyPolicy = () => {
    return (
        <section className="ContentPrivacy">
            <CommonHeroComponent
                title="" Heading="PRIVACY POLICY" Para="Convallis vivamus at cras porta nibh velit Convallis vivamus at cras porta nibh velit" backgroundImg="/images/creatives/AboutHero-Banner.jpg" />
            <div className="container">
                <div className="col">
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>INFORMATION WE COLLECT FROM YOU</h1>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>STORAGE AND SECURITY OF YOUR INFORMATION</h1>
                            <h2>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>COOKIES AND PIXELS</h1>
                            <h2>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>SHARING YOUR INFORMATION WITH THIRD PARTIES</h1>
                            <h2>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>DISCLOSURE OF YOUR INFORMATION</h1>
                            <h2>
                                ...
                                Creative Squad, our customers or third parties. If there is a
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>LINKS TO OTHER WEBSITES</h1>
                            <h2>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>CHANGE IN PRIVACY POLICY</h1>
                            <h2>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>WHAT RIGHTS YOU HAVE OVER YOUR DATA</h1>
                            <h2>
                    ...
                    <div className="row mb-3">
                        <div className="col-12">
                            <h1 className='head-h3'>CONTACT US</h1>
                            <h2>
