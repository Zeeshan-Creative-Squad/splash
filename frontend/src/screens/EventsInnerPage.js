...
const EventsInnerPage = () => {
    return (
        <div>
            <HeroComponentTwo title="" Heading="100M RACE" Para="Canadian Cheer Montréal Mayhem is a signature event in the heart of Montréal! This event brings together teams from across Ontario and Québec for a high-quality competition experience." backgroundImg="/images/creatives/Events-Banner.jpg" />
